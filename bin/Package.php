...
class Package {
    ...
    private $filecsv = 'var/lib/mz/mz_base.csv';      # Lista de pacotes no repositório
    private $dircsv = 'var/lib/mz/';                  # Diretório do arquivo .csv
    private $dirlist = 'var/lib/banana/list/';        # Lista de pacotes instalados
